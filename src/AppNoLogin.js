    ...
    <div>
        ...
        <div className="header-content">
          <nav>
            <ul className="menu">
              ...
              <li><a onClick={() => handleNavigation('/Bim2')}>BMI</a></li>
              <li><a onClick={() => handleNavigation('/st')}>TRACKER</a></li>
      ...
      <main>
        <section className="hero">
          ...
          <p></p>
          <button className="cta-button" onClick={() => handleNavigation('/TrainersList')}>FIND TRAINERS</button>
          {error && <p className="error-message">{error}</p>} {/* Display error message */}
        </section>

        <section className="state-section" ref={stateSectionRef}>
          <p>START YOUR JOURNEY</p>
          <button className="cta-button" onClick={() => handleNavigation('/Bim2')}>FIT CHECK</button>
        </section>
        ...
        <section className="content">
          ...
          <div className="muscle-box" ref={(el) => (muscleBoxRefs.current[8] = el)} onClick={() => handleBoxClick('Cardio')}>
            Cardio
            <img src="/cardio.png" alt="Cardio Workout" className="muscle-image" />
          </div>
        </section>
      </main>
